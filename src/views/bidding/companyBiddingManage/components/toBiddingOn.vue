<template>
  <PageTitle title="项目名称-正在竞标" @back-to-list="backList"/>

  <ContentWrap>
    <el-row class="projectForm" :gutter="20">
      <el-col :span="6">
        <el-form-item label="开标时间">
          <el-input :disabled="true" v-model="formData.templateName"/>
        </el-form-item>
      </el-col>
      <el-col :span="6">
      ...
      <el-col :span="6">
        <el-form-item label="中标服务商数">
          <el-input :disabled="true" v-model="formData.templateName"/>
        </el-form-item>
      </el-col>
      <el-col :span="6">
        <el-form-item label="项目总量">
          <el-input :disabled="true" v-model="formData.templateName"/>
        </el-form-item>
      </el-col>
    </el-row>

    <CountDown :ifBiddingOn="true"/>

...
<!--          {{getId}}-->
            ...
            <el-table-column label="计费项" align="center">
              <template #default="scope">
                <MyInputTable v-model="scope.row.feeItemName" :tableId="scope.$index" :disabled="disabled || itemDisabled"
                              :valueKey="tableConfigFee.valueKey" :tableOption="tableConfigFee.tableOption"
                              :tableConfig="tableConfigFee" :setFormData="tableConfigFee.setFormData" :clearData="tableConfigFee.clearData"
                              />
              </template>
            </el-table-column>
            ...
            <el-table-column label="币种" align="center">
              <template #default="scope">
                <MyInputTable v-model="scope.row.feeCyName" :tableId="scope.$index" :disabled="disabled || itemDisabled"
                              ...
                              :tableConfig="tableConfigCurrency" :setFormData="tableConfigCurrency.setFormData" :clearData="tableConfigCurrency.clearData"
                />
              </template>
            </el-table-column>
              ...
              <template #default="scope">
                <div class="time-picker">
                  <el-date-picker
                    clearable
                    :disabled="disabled || itemDisabled"
                    v-model="scope.row.feeBegin"
                    value-format="YYYY-MM-DD HH:mm:ss"
                    type="datetime"
                    placeholder="请选择报价生效日期"
                  />
                </div>
              </template>
            </el-table-column>
            ...
            <el-table-column fixed="right" label="操作" align="center" width="170">
              <template #default="scope">
                <el-button
                  type="primary"
                  text
                  @click="toEditItem(scope.row,scope.$index)"
                  v-if="scope.$index != 0"
                >
                  编辑
                </el-button>
    ...
    <div class="pagination-view">
      <Pagination
        :total="linePageParams.total"
        v-model:page="linePageParams.pageNo"
        v-model:limit="linePageParams.pageSize"

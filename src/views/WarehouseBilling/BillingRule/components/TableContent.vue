...
const checkTemplate = (id) => {
    router.push({ path: '/warehousebilling/billingRule/operatetemplate', query: { id, type: 0 } })
}

const updateTemplate = (id) => {
    router.push({ path: '/warehousebilling/billingRule/operatetemplate', query: { id, type: 1 } })
}

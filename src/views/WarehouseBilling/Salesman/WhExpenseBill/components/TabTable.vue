    ...
    <div class="main">
        <div class="tableBox">
            <el-table :data="tableData" border style="width: 100%" :cell-style="{ textAlign: 'center' }"
                ...
                <el-table-column prop="date" label="费用" width="300" />
                <el-table-column prop="name" label="系统账单" />
                <el-table-column prop="address" label="供应商账单" />
            </el-table>
        </div>
        <div class="formBox">
...
const tableRowClassName = (row, rowIndex) => {
    ...
    if (row.row.name !== row.row.address) {
        return 'danger-row'
    } else {
        return 'success-row'
    }

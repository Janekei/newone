...
export const getWarehouseList = async (params) => {
    return await request.get({ url: '/gsc/baseWarehouse/get', params })
}

// 新增数据
export const addWarehouseItem = async (data) => {
    return await request.post({ url: '/gsc/baseWarehouse/create', data })
}

// 更新数据
export const changeWarehouseItem = async (data) => {
    // console.log(params)
    return await request.put({ url: '/gsc/baseWarehouse/update', data })
}

// 删除数据
export const deleteWarehouseItem = async (params) => {
    console.log(params)
    return await request.delete({ url: '/gsc/baseWarehouse/delete', params })
}

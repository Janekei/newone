...
export const toUsedTemps = (data) => {
  return request.post({ url: '/gsc/fee/template/rule/usedTemp', data })
}

// 获得仓储计费规则明细分页
export const getRuleDetail = (params) => {
  return request.get({ url: '/gsc/fee/template/rule/details/page', params })
}

// 新建仓储计费规则明细
export const createRuleDetail = (data) => {
  return request.post({ url: '/gsc/fee/template/rule/details/create', data })
}
...
export const deleteRuleDetail = (id: number) => {
  return request.delete({ url: '/gsc/fee/template/rule/details/deleteById?id=' + id})
}

// 获得仓储计费规则基础信息
export const getRuleBaseInfo = (params) => {
  return request.get({ url: '/gsc/fee/template/rule/findById', params })
}

// 更新仓储计费规则基础信息
export const updateRuleBaseInfo = (data) => {
  return request.post({ url: '/gsc/fee/template/rule/update', data })
}
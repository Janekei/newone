export default {
 ...
 router: {
  ...
  sticky: 'Sticky',
  warehouseHome: 'Warehouse homepage',
  logisticsHome: 'Wogistics homepage',
  saleHome: 'Sale homepage',
  inventorySnapshot: 'Inventory Snapshot',
  inboundInstruction: 'Inbound instruction',
  outboundinstruction: 'Outbound instruction',
  inventoryQuery: 'Inventory Query',
  warehousingquery: 'Warehousing query',
